...
class Nvd3(object):
  ...
  def line(self, data=None, y_columns=None, x_axis=None, title=None, filters=None, profile=None, options=None,
    ...
    line_chart._vals = self.parent.context.rptObj.js.data.records(data).to.nvd3.line(y_columns, x_axis, profile or False)
  ...
  def pie(self, data=None, y_column=None, x_axis=None, title=None, filters=None, profile=None, options=None,
    ...
    pie_chart._vals = self.parent.context.rptObj.js.data.records(data).to.nvd3.pie(y_column, x_axis, profile or False)
    return pie_chart
