        ...
        for typ, icon in commands:
            if icon:
                ...
                r = self.page.ui.icons.awesome(
                    icon, align="center", tooltip=typ, height=height, width=(15, 'px'), options=options,
                    profile=profile)
                ...
                menu_items.append(r)
        container = self.page.ui.menu(table, update_funcs=update_funcs, menu_items=menu_items, post=post,
                                      editable=False,
