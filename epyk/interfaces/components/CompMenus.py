...
class Menus:
    ...
    def icons(self, data: List[Union[str, dict]] = None, width=(100, '%'), height: Union[tuple, int] = (None, 'px'),
              align: str = "center",
    ...
    """
        ...
        component.css(
            {"border": "1px solid %s" % component.page.theme.greys[4], "padding": "2px", "min-height": "40px"})
