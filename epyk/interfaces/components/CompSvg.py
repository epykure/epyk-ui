...
class SVG:
    ...
    def new(self, width: types.SIZE_TYPE = (500, "px"), height: types.SIZE_TYPE = (300, "px")) -> html.HtmlSvg.SVG:
        """SVG stands for Scalable Vector Graphics. SVG defines vector-based graphics in XML format.

        Usage::
          svg = page.ui.svg.new(width=200)
        ...
        if not isinstance(width, tuple):
            width = (width, "px")
        html_svg =  html.HtmlSvg.SVG(self.page, width, height)
        return html_svg
    ...
    def line(self, x1: float = 0, y1: float = None, x2: float = None, y2: float = None,
             ...
             profile: types.PROFILE_TYPE = None) -> html.HtmlSvg.SVG:
        """Entry point to the basic line definition in a SVG HTML Tag.

        Usage::
          page.ui.svg.line(10, 30, 40, 69)
        ...
        html_svg = html.HtmlSvg.SVG(self.page, width, height, options=options, profile=profile)
        html_svg.line(x1, y1, x2, y2)
        return html_svg

    def circle(
            self, x: float, y: float, r: float, width: types.SIZE_TYPE = (500, "px"),
    ...
    def polyline(self, points: List[tuple], width: types.SIZE_TYPE = (500, "px"), height: types.SIZE_TYPE = (300, "px"),
                 options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlSvg.SVG:
        """
    ...
    def triangle(self, point1: tuple, point2: tuple = None, point3: tuple = None, fill: str = 'None',
        ...
        tri = html.HtmlSvg.SVG(self.page, width, height, options=options, profile=profile)
    ...
    def axes(self, size: int = 10, width: types.SIZE_TYPE = (500, "px"), height: types.SIZE_TYPE = (300, "px"),
             html_code: str = None, options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlSvg.SVG:
        """

        Usage::
          svg = page.ui.svg.axes()
        ...
        :param profile: Optional. A flag to set the component performance storage
        """
        svg = html.HtmlSvg.SVG(self.page, width, height, options=options, profile=profile)
        ...
        pl = svg.polyline([(size, size), (size, height[0] - size), (width[0] - size, height[0] - size)]).css(
            {'stroke': "black"})
    ...
    def rectangle(self, x: float, y: float, width: types.SIZE_TYPE = (500, "px"), height: types.SIZE_TYPE = (300, "px"),
                  fill: str = None, rx: float = 0, ry: float = 0, options: dict = None,
                  profile: types.PROFILE_TYPE = None) -> html.HtmlSvg.SVG:
        """
        ...
        :param profile: Optional. A flag to set the component performance storage.
        """
        rect = html.HtmlSvg.SVG(self.page, (900, "px"), (200, "px"), options=options, profile=profile)
        rect.rect(x, y, width, height, fill, rx=rx, ry=ry)
        return rect

    def heart(
            self, w: float, h: float, fill: str = 'none', width: types.SIZE_TYPE = (500, "px"),
            height: types.SIZE_TYPE = (300, "px"), options: dict = None, profile: types.PROFILE_TYPE = None
    ) -> html.HtmlSvg.SVG:
        """
        ...
        """
        svg = html.HtmlSvg.SVG(self.page, width, height, options=options, profile=profile)
        svg.polygon([(w, w), (3 / 4 * h, 3 / 4 * h), (h, w), (h, 3 / 4 * w), (9 / 10 * h, 6 / 10 * w),
                     (8.5 / 10 * h, 6 / 10 * w),
                     (3 / 4 * h, 3 / 4 * w), (2 / 3 * h, 6 / 10 * w), (6 / 10 * h, 6 / 10 * w), (w, 3 / 4 * w), (w, w)],
                    fill=fill)
        return svg
    ...
    def path(self, x: float = 0, y: float = 0, fill: Optional[str] = 'none', origin: bool = False, bespoke_path=None,
             options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlSvg.Path:
        """
        ...
        """
        path = html.HtmlSvg.Path(self.page, x, y, fill, origin, bespoke_path, options=options, profile=profile)
        return path
