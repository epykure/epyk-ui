...
class Fields:
    ...
    """
        ...
        if label is not None:
            ...
            component.label = self.page.ui.texts.label(
                ...
                html_code=HTML_CODE_LABEL.format(html_code) if html_code is not None else html_code)
    ...
    """
        ...
        component = html.HtmlDates.TimePicker(
            self.page, str(date).split(" ")[1].split(".")[0], label, icon, color, html_code, profile, options or {},
            helper)
        html.Html.set_component_skin(component)
        return component
 ...
 -
    ...
    def slider(self, value: float = 0, min: float = 0, max: float = 10, step: float = 1,
    ...
    """
        ...
        if completion_date > today:
            ...
            while next_day < completion_date:
                ...
                next_day += datetime.timedelta(days=1)
            component.tooltip(
                "to be completed in {} ({} days left)".format(completion_date.strftime("%b %d"), remaining_days))
