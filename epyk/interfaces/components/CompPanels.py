...
class Panels:
    ...
    def arrows_down(self, color: str = None, width: types.SIZE_TYPE = (100, '%'),
    ...
    def sliding(self, components, title, color: str = None, align: str = "center", width: types.SIZE_TYPE = (100, "%"),
                ...
                profile: types.PROFILE_TYPE = False) -> html.HtmlContainer.PanelSlide:
        """Add a sliding panel.
    ...
    def split(self, left: html.Html.Html = None, right: html.Html.Html = None, width: types.SIZE_TYPE = (100, '%'),
              ...
              right_width: types.SIZE_TYPE = None, resizable: bool = True, helper: str = None,
              options: types.OPTION_TYPE = None,
...
class Slidings:
    ...
    :param profile: Optional. A flag to set the component performance storage
    """
        sliding = self.page.ui.panels.sliding(components, color=color, title=title, align=align, width=width,
                                              height=height,
