 ...
 -
    ...
    """
        inp = self.page.ui.fields.input(
            value=value, label=label, html_code="%s_input" % html_code, placeholder=placeholder, icon=icon,
            profile=profile,
            options=options)
 ...
 -
    ...
    """
        ...
        for i, rec in enumerate(record):
            ...
            inp = self.page.ui.fields.input(label=rec["label"], html_code=html_code_input, options=options,
                                            profile=profile)
