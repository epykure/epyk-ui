...
class TextReferences:
    ...
    """
        ...
        text = self.page.ui.text(content % (text, author, name, edition, year, page), html_code=html_code,
                                 options=options,
                                 profile=profile)
...
class Texts:
    ...
    """
        width = Arguments.size(width, unit="px")
        height = Arguments.size(height, unit="px")
        html_label = html.HtmlText.Span(self.page, text, color, align, width, height, html_code, tooltip, options,
                                        profile)
        html.Html.set_component_skin(html_label)
        return html_label
    ...
    """
        ...
        div.label = self.page.ui.text(
            label, options=options, html_code=html_code if html_code is None else "%s_label" % html_code,
            profile=profile)
    ...
    """
        ...
        html_light = html.HtmlText.Highlights(
            self.page, text, title, icon, category or "info", color, width, height, html_code, helper, options or {},
            profile)
