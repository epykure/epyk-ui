...
from ..py import types
from ..css import Defaults_css, FontFamily, enums
from ...interfaces import Arguments
...
def autoPrefixer(prop: str):
    ...
    `w3schools <https://www.w3schools.com/cssref/css3_browsersupport.asp>`_
...
class CssMixin:
    ...
    def css(self, val: Any):
        """Must be overridden when defining the Mixin"""

    @property
    def align_content(self):
        return self.css("align-content")
    ...
    def animation(self):
        ...
        `w3schools <https://www.w3schools.com/css/css3_animations.asp>`_
        """
    ...
    def animation_delay(self):
        return self.css("animation-delay")
    ...
    def animation_direction(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-direction.asp>`_
        """
    ...
    def animation_duration(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-duration.asp>`_
        """
    ...
    def animation_fill_mode(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-fill-mode.asp>`_
        """
    ...
    def animation_iteration_count(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-iteration-count.asp>`_
        """
    ...
    def animation_name(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-name.asp>`_
        """
    ...
    @property
    def animation_play_state(self):
        return self.css("animation-play-state")
    ...
    def animation_timing_function(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_animation-timing-function.asp>`_
        """
    ...
    @property
    def appearance(self):
        """	This property is frequently used in XUL stylesheets to design custom widgets with platform-appropriate
        styling. It is also used in the XBL implementations of the widgets that ship with the Mozilla platform.

        `w3schools <https://developer.mozilla.org/en-US/docs/Web/CSS/appearance>`_
        """
    ...
    def backface_visibility(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_backface-visibility.asp>`_
        """
    ...
    def background(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/css3_pr_background.asp>`_
        """
    ...
    def background_attachment(self):
        return self.css("background-attachment")
    ...
    @property
    def background_blend_mode(self):
        return self.css("background-blend-mode")
    ...
    def background_clip(self):
        return self.css("background-clip")
    ...
    def background_color(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/pr_background-color.asp>`_
        """
    ...
    def background_image(self):
        return self.css("background-image")
    ...
    def background_url(self, val: str, size: str = "contain", repeat: str = "no-repeat", position="relative",
        ...
        """	Set the container background from an url. This will also set some default usual property.
    ...
    @property
    def background_origin(self):
        return self.css("background-origin")
    ...
    def background_size(self):
        return self.css("background-size")
    ...
    def border_bottom_color(self):
        return self.css("border-bottom-color")
    ...
    @property
    def border_bottom_left_radius(self):
        return self.css("border-bottom-left-radius")
    ...
    @property
    def border_bottom_right_radius(self):
        return self.css("border-bottom-right-radius")
    ...
    def border_bottom_style(self):
        return self.css("border-bottom-style")
    ...
    def border_bottom_width(self):
        return self.css("border-bottom-width")
    ...
    @property
    def border_image_outset(self):
        return self.css("border-image-outset")
    ...
    @property
    def border_image_repeat(self):
        return self.css("border-image-repeat")
    ...
    @property
    def border_image_slice(self):
        return self.css("border-image-slice")
    ...
    @property
    def border_image_source(self):
        return self.css("border-image-source")
    ...
    @property
    def border_image_width(self):
        return self.css("border-image-width")
    ...
    def border_left_color(self):
        return self.css("border-left-color")
    ...
    def border_left_style(self):
        return self.css("border-left-style")
    ...
    def border_left_width(self):
        return self.css("border-left-width")
    ...
    def border_right_color(self):
        return self.css("border-right-color")
    ...
    def border_right_style(self):
        return self.css("border-right-style")
    ...
    def border_right_width(self):
        return self.css("border-right-width")
    ...
    def border_top_color(self):
        return self.css("border-top-color")
    ...
    @property
    def border_top_left_radius(self):
        return self.css("border-top-left-radius")
    ...
    @property
    def border_top_right_radius(self):
        return self.css("border-top-right-radius")
    ...
    def border_top_style(self):
        return self.css("border-top-style")
    ...
    def border_top_width(self):
        return self.css("border-top-width")
    ...
    @property
    def column_rule_color(self):
        return self.css("column-rule-color")
    ...
    @property
    def column_rule_style(self):
        return self.css("column-rule-style")
    ...
    @property
    def column_rule_width(self):
        return self.css("column-rule-width")
    ...
    def counter_increment(self):
        return self.css("counter-increment")
    ...
    def flex_direction(self):
        return self.css("flex-direction")
    ...
    @float.setter
    def float(self, val: str):
        val = val if val is not None else 'none'
        if Defaults_css.CSS_EXCEPTIONS and val not in enums.FLOAT:
    ...
    def font_family(self):
        ...
        `w3schools <https://www.w3schools.com/cssref/pr_font_font-family.asp>`_
        """
    ...
    def font_size_adjust(self):
        return self.css("font-size-adjust")
    ...
    def grid_auto_columns(self):
        return self.css("grid-auto-columns")
    ...
    @property
    def grid_auto_flow(self):
        return self.css("grid-auto-flow")
    ...
    def grid_auto_rows(self):
        return self.css("grid-auto-rows")
    ...
    @property
    def grid_column_end(self):
        return self.css("grid-column-end")
    ...
    @property
    def grid_column_gap(self):
        return self.css("grid-column-gap")
    ...
    def grid_column_start(self):
        return self.css("grid-column-start")
    ...
    @property
    def grid_row_end(self):
        return self.css("grid-row-end")
    ...
    @property
    def grid_row_gap(self):
        return self.css("grid-row-gap")
    ...
    @property
    def grid_row_start(self):
        return self.css("grid-row-start")
    ...
    def grid_template_areas(self):
        return self.css("grid-template-areas")
    ...
    def grid_template_columns(self):
        return self.css("grid-template-columns")
    ...
    def grid_template_rows(self):
        return self.css("grid-template-rows")
    ...
    def hanging_punctuation(self):
        return self.css("hanging-punctuation")
    ...
    def letter_spacing(self):
        return self.css("letter-spacing")
    ...
    def list_style_image(self):
        return self.css("list-style-image")
    ...
    def list_style_position(self):
        return self.css("list-style-position")
    ...
    def list_style_type(self):
        return self.css("list-style-type")
    ...
    def margin_h(self, val):
        ...
        if self.component is not None and isinstance(val,
                                                     int) and self.component.style.css.width is not None and self.component.style.css.width.endswith(
                "%"):
    ...
    @property
    def mix_blend_mode(self):
        return self.css("mix-blend-mode")
    ...
    def object_position(self):
        return self.css("object-position")
    ...
    def outline_offset(self):
        return self.css("outline-offset")
    ...
    def page_break_after(self):
        return self.css("page-break-after")
    ...
    def page_break_before(self):
        return self.css("page-break-before")
    ...
    def page_break_inside(self):
        return self.css("page-break-inside")
    ...
    @property
    def perspective_origin(self):
        return self.css("perspective-origin")
    ...
    def pointer_events(self):
        return self.css("pointer-events")
    ...
    def scroll_behavior(self):
        return self.css("scroll-behavior")
    ...
    def text_align_last(self):
        return self.css("text-align-last")
    ...
    def text_decoration(self):
        return self.css("text-decoration")
    ...
    def text_decoration_color(self):
        return self.css("text-decoration-color")
    ...
    def text_decoration_line(self):
        return self.css("text-decoration-line")
    ...
    def text_decoration_style(self):
        return self.css("text-decoration-style")
    ...
    def transform_origin(self):
        return self.css("transform-origin")
    ...
    def transform_style(self):
        return self.css("transform-style")
    ...
    def transition_delay(self):
        return self.css("transition-delay")
    ...
    def transition_duration(self):
        return self.css("transition-duration")
    ...
    @property
    def transition_property(self):
        return self.css("transition-property")
    ...
    def sticky(self, top: int = 0, bottom: Optional[int] = None, left: Optional[int] = None,
