...
class ThemeDark(object):
  ...
  colors = ['#263238', '#37474f', '#455a64', '#546e7a', '#607d8b', '#78909c','#90a4ae', '#b0bec5', '#cfd8dc', '#eceff1']
  greys = ['#000000', '#212121', '#424242', '#616161', '#757575', '#9e9e9e', '#bdbdbd', '#e0e0e0', '#eeeeee', '#f5f5f5', '#FFFFFF']
  warning, danger, success = ('#FFF3CD', '#e2ac00'), ("#F8D7DA", "#C00000"), ('#e8f2ef', '#3bb194')


class ThemeGrey(object):
  name = 'grey'
  ...
  greys = ['#273037', '#212121', '#273037', '#3F484D',
           '#757575', '#9e9e9e', '#bdbdbd', '#e0e0e0',
           '#eeeeee', '#f5f5f5', '#FFFFFF']

  charts = ['#009999', '#336699', '#ffdcb9',
            '#cc99ff', '#b3d9ff', '#ffff99',
            '#000066', '#b2dfdb', '#80cbc4',
  ...
  warning = ('#FFF3CD', '#e2ac00')
  danger = ('#F8D7DA', '#C00000')
  success = ('#e8f2ef', '#3bb194')
