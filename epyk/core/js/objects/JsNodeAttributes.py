...
class JsAttributes(JsObject.JsObject):
  ...
  """
    ...
    @property
    def name(self) -> str:
        """The name property returns the name of the attribute. This property is read-only.
    ...
    def item(self, i: Union[int, primitives.JsDataModel]) -> str:
    ...
    def removeNamedItem(self, name: str) -> str:
    ...
    def setNamedItem(self, attrs: types.JS_DATA_TYPES) -> str:
    ...
    def getNamedItem(self, node_name: types.JS_DATA_TYPES) -> str:
