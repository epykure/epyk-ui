...
class JsPivotSumAgg(JsPivotAggFnc):
    ...
    push: str = 'this.keyAgg += parseFloat(record[attributeArray[0]])'
    value: str = 'return this.keyAgg'
    format: str = 'return numberWithCommas(x.toFixed(%(digits)s))'
...
class JsPivotAbsSumAgg(JsPivotSumAgg):
    ...
    """
    name: str = "Abs Sum Agg"
    push: str = 'this.keyAgg += Math.abs(parseFloat(record[attributeArray[0]]))'
...
class JsPivotMaxAgg(JsPivotSumAgg):
    ...
    name: str = "Max Agg"
    keyAgg: str = '-Infinity'
    push: str = "this.keyAgg = Math.max(this.keyAgg, parseFloat(record[attributeArray[0]]))"
    value: str = 'return this.keyAgg'
...
class JsPivotMinAgg(JsPivotSumAgg):
    ...
    name: str = "Min Agg"
    keyAgg: str = 'Infinity'
    push: str = "this.keyAgg = Math.min(this.keyAgg, parseFloat(record[attributeArray[0]]))"
    value: str = 'return this.keyAgg'
...
class JsPivotAvgAgg(JsPivotSumAgg):
    ...
    name: str = "Avg Agg"
    keyAgg = 0
    push: str = "this.keyAgg += parseFloat(record[attributeArray[0]]); this.tmpVal += 1"
    value: str = "return this.keyAgg / this.tmpVal"
...
class JsPivotDiff(JsPivotAggFnc):
    ...
    name: str = "diff Agg"
    keyAgg, key2Agg = 0, 0
    push: str = 'this.key1Agg += parseFloat(record[attributeArray[0]]); this.key2Agg += parseFloat(record[attributeArray[1]])'
    value: str = 'return this.key1Agg - this.key2Agg'
    format: str = 'return numberWithCommas(x.toFixed(2))'
...
class JsPivotDiffPct(JsPivotDiff):
    ...
    """
    name: str = "diff Pct Agg"
    value: str = 'return (this.key1Agg - this.key2Agg) / this.key1Agg'
...
class JsPivotDiffAbs(JsPivotDiff):
    ...
    """
    name: str = "diff Abs Agg"
    value: str = 'return Math.abs(this.key1Agg - this.key2Agg)'
...
class JsPivotDiffPctAbs(JsPivotDiff):
    ...
    """
    name: str = "diff Abs Pct Agg"
    value: str = 'return Math.abs((this.key1Agg - this.key2Agg) / this.key1Agg)'
