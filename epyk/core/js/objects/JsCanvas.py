...
from ..primitives import JsObjects, JsNumber, JsBoolean
from ..packages import JsQuery, JsQueryUi
from .. import JsUtils
    ...
    def jquery_ui(self) -> JsQueryUi.JQueryUI:
        ...
        if self._jquery_ui is None:
            self._jquery_ui = JsQueryUi.JQueryUI(
                self.component, selector=JsQuery.decorate_var("#%s" % self.component.html_code))
