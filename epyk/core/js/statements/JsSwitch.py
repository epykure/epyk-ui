...
class JsSwitch:
  ...
  """
    ...
    def case(self, value, js_funcs: Union[list, str], strict: bool = False,
    ...
    def caseRange(self, min: Union[int, primitives.JsDataModel], max: Union[int, primitives.JsDataModel],
        ...
        :param max: The min value for this range.
        :param min: The max value for this range.
        :param js_funcs: The JavaScript functions.
        :param include_value: Optional. To specify if the pivot value is included.
        """
    ...
    def toStr(self):
        ...
        for var, js_funcs in self.__js:
            str_data.append("case %s: {%s; break}" % (
                JsUtils.jsConvertData(var, None),
                JsUtils.jsConvertFncs(js_funcs, toStr=True, profile=self.profile)))
