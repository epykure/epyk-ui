...
class JsTry:
    ...
    def catch(self, js_funcs: Union[list, str], profile: Optional[Union[dict, bool]] = False):
        """Block of code to handle errors. The variable to be used if error in this loop.
    ...
    def except_(self, js_funcs: Union[list, str], profile: Optional[Union[dict, bool]] = False):
        """Block of code to handle errors (catch in JavaScript). The variable to be used is err in this loop.
