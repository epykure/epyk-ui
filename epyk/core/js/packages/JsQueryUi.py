    ...
    """
        ...
        if self.component.is_range:
            return JsObjects.JsObjects.get(
                '%(id)s.slider("values", %(value)s); %(id)s.slider("option", "slide").call(%(id)s, null, {values: %(value)s})' % {
                    "id": self.component.dom.jquery.varId, "value": value})

        return JsObjects.JsObjects.get(
            '%(id)s.slider("value", %(value)s); %(id)s.slider("option", "slide").call(%(id)s, null, {value: %(value)s})' % {
                "id": self.component.dom.jquery.varId, "value": value})
...
class ProgressBar(JQueryUI):
    ...
    """
        ...
        value = JsUtils.jsConvertData(value, None)
        return JsObjects.JsObjects.get(
            '%s.progressbar("option", %s, %s)' % (self.component.dom.jquery.varId, data, value))
    ...
    """
        value = JsUtils.jsConvertData(value, None)
        return JsObjects.JsObjects.get(
            '%(varId)s.progressbar("value", %(varId)s.progressbar("value") + %(jsValue)s)' % {
...
class Autocomplete(JQueryUI):
    ...
    """
        ...
        value = JsUtils.jsConvertData(value, None)
        return JsObjects.JsObjects.get(
            '%s.autocomplete("option", %s, %s)' % (self.component.dom.jquery.varId, data, value))
    ...
    """
        data = JsUtils.jsConvertData(data, None)
        return JsObjects.JsObjects.get(
            '%s.autocomplete("option", "source", %s)' % (self.component.dom.jquery.varId, data))
    ...
    """
        return JsUtils.jsWrap(
            '%s.autocomplete("instance")._renderItem = %s' % (self.component.dom.jquery.varId, callback))
...
class Datepicker(JQueryUI):
    ...
    """
        ...
        value = JsUtils.jsConvertData(value, None)
        return JsObjects.JsObjects.get(
            '%s.datepicker("option", %s, %s)' % (self.component.dom.jquery.varId, data, value))
