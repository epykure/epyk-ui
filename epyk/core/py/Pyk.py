    ...
    """
        ...
        if pyk_file.endswith('.py'):
            ...
            try:
                ...
                if not autoinstall:
                    print(
                        "The package is not found on your environment, you will need to install it manually or use the autoinstall argument")
                    raise
        ...
        if pyk_file not in pyk_dict:
            raise EpykMissingPykException(
                'The specified pyk file: %s does not call the exports function, if this is your file make sure to call this!' % pyk_file)
