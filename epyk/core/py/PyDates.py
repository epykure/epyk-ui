...
class PyDates:
    ...
    @property
    def cob(self):
        """ Returns the last close of business date. In this property the parameter weekdays is forced to True.
    ...
    @property
    def month_end(self):
        """ Returns the last month end date. In this property the parameter weekdays is forced to True.
    ...
    def range_dates(self, to_dt: str, from_dt: Optional[str] = None, weekdays: bool = True):
        ...
        Usage::
          ...
          ['2019-01-11', '2019-01-10', '2019-01-09', '2019-01-08', '2019-01-07', '2019-01-04', '2019-01-03',
    ...
    @staticmethod
    def elapsed(delta_time, with_time: bool = False) -> dict:
