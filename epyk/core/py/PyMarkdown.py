...
PARAMS = {
    ...
    "width": {"type": "Tuple", "Optional": True,
              "value": "A tuple with the integer for the component width and its unit."},
    "height": {"type": "Tuple", "Optional": True,
               "value": "A tuple with the integer for the component height and its unit."},
    "icon": {"type": "String", "Optional": True,
             "value": "A string with the value of the icon to display from font-awesome."},
    "htmlCode": {"type": "String", "Optional": True,
                 "value": "An identifier for this component (on both Python and Javascript side)."},
    "tooltip": {"type": "String", "Optional": True, "value": "A string with the value of the tooltip."},
    "profile": {"type": "Boolean | Dictionary", "Optional": True,
                "value": "A flag to set the component performance storage."},
    "options": {"type": "Dictionary", "Optional": True,
                "value": "Specific Python options available for this component."},
    "top": {"type": "Tuple", "Optional": True,
            "value": "A tuple with the integer for the component's distance to the top of the page."},
    "left": {"type": "Tuple", "Optional": True,
             "value": "A tuple with the integer for the component's distance to the left of the page."},
    ...
    "onReady": {"type": "Boolean", "Optional": True,
                "value": "Specify if the event needs to be trigger when the page is loaded."},
            ...
            if m is not None:
                for g in m:
                    ...
                    if "%s" in interface['pattern']:
                        convert_data = convert_data.replace(interface['pattern'] % g,
                                                            "||%s_%s||" % (interface['cls'], count))
                    else:
                        convert_data = convert_data.replace(interface['pattern'],
                                                            "||%s_%s||" % (interface['cls'], count))
                    count += 1
        resolved_data = []
