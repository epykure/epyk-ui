...
class Links:
    ...
    def alternative(
            self, href: str, file_type: str = "text/css", media: Optional[str] = None,
            title: str = "alternate stylesheet"):
        """
...
class Header:
    ...
    """
        from epyk.conf.global_settings import (ASSETS_SPLIT, ASSETS_STATIC_ROUTE, ASSETS_STATIC_PATH,
                                               ASSETS_STATIC_PUBLIC)
