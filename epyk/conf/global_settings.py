...
PACKAGES_PATH: Optional[str] = os.environ.get("PACKAGES_PATH")
""" Common path with a local copy for the external packages """

COMPONENTS_EXTENSION_PATH: Optional[str] = os.environ.get("COMPONENTS_EXTENSION_PATH")
""" Used by standalone external component to load """

NPM_NODE_MODULES_PATH: Optional[str] = os.environ.get("NPM_NODE_MODULES_PATH")
...
ASSETS_SPLIT: bool = os.environ.get("ASSETS_SPLIT", 'N') == 'Y'
""" Flag to generate resources to dedicated files """
ASSETS_SPLIT_MINIFY: bool = os.environ.get("ASSETS_SPLIT_MINIFY", 'Y') == 'Y'
...
ASSETS_OUT_PATH: str = os.environ.get("HTML_OUT_PATH", os.path.join(os.getcwd(), "outs"))
""" Target output path in which all web assets will be generated """
ASSETS_STATIC_PATH: str = os.environ.get("ASSETS_STATIC_PATH", ASSETS_OUT_PATH)
""" Target output path for the HTML report resources """
ASSETS_STATIC_ROUTE: str = os.environ.get("ASSETS_STATIC_ROUTE", ".")
""" Url root on the server to access the attached resources """
ASSETS_STATIC_CONFIG: str = os.environ.get("ASSETS_STATIC_CONFIG", "configs")
""" Folder and url end route for configuration files """
ASSETS_STATIC_DATA: str = os.environ.get("ASSETS_STATIC_DATA", "data")
""" Folder and url end route for data files """
ASSETS_STATIC_CSS: str = os.environ.get("ASSETS_STATIC_CSS", "css")
""" Folder and url end route for CSS files """
ASSETS_STATIC_JS: str = os.environ.get("ASSETS_STATIC_JS", "js")
""" Folder and url end route for JavaScript files """
ASSETS_STATIC_PUBLIC: str = os.environ.get("ASSETS_STATIC_PUBLIC", "public")
""" Folder and url end route for other resources (images, icons...) """

# Icons global settings
ICONS_FAMILY: str = os.environ.get("ICONS_FAMILY", 'font-awesome')
""" Default family reference """

IMPORTS_EXPR: str = "%(cdnjs)s/%(path)s%(script)s"
""" Common path to build the external files url in the HTML header - Default case %(cdnjs)s/%(path)s%(script)s """

IMPORT_PROXY: str = os.environ.get("IMPORT_PROXY", '')
""" Proxy server to use for pip install """
IMPORT_PCK_REPO: Optional[str] = os.environ.get("IMPORT_PCK_REPO", None)
""" """
IMPORT_AUTOLOAD: bool = os.environ.get("IMPORT_AUTOLOAD", 'N') == 'Y'
""" """
IMPORT_USE_NPM_UNPK: bool = os.environ.get("IMPORT_USE_NPM_UNPK", 'N') == 'Y'
""" """
IMPORT_JSDELIVER_URL: str = os.environ.get("IMPORT_JSDELIVER_URL", "https://cdn.jsdelivr.net/npm")
""" """
IMPORT_CDNJS_URL: str = os.environ.get("IMPORT_CDNJS_URL", 'https://cdnjs.cloudflare.com/ajax/libs')
""" """
IMPORT_UNPKG_URL: str = os.environ.get("IMPORT_UNPKG_URL", "https://www.unpkg.com/")
""" """
IMPORT_STATIC_PATH: str = os.environ.get("IMPORT_STATIC_PATH", "/static")
""" """

GOOGLE_SITE_KEY: str = "6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI"
""" """
...
def get_static_files(filenames: List[str], full_path: Optional[str] = None) -> List[Path]:
