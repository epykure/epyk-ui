...
class Gallery:
    ...
    """
        img = self.page.ui.images.img(
            img, path=path, width=width, height=height, align=align, html_code=html_code, options=options,
            profile=profile)
    ...
    def folders(self, path: str, columns: int = 6, images: dict = None, position: str = "top",
                width: types.SIZE_TYPE = (None, '%'),
                height: types.SIZE_TYPE = ('auto', ''), options: types.OPTION_TYPE = None,
